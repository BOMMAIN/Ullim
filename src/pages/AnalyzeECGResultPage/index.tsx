...
const AnalyzeECGResultPage = () => {
  ...
  const { aiResults, analysisResult, isFromSignup, signupData } =
    location.state || {};
      ...
      <TabContainer activeTab={activeTab} setActiveTab={setActiveTab}>
        {activeTab === "result" ? (
          <S.ResultSection>
            ...
            {/* 의미하는 바와 권장사항 */}
            <S.AnalysisText>
              {analysisResult?.analysis?.implications?.map(
                (implication: string, index: number) => (
